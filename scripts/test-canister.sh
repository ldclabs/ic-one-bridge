...
cargo build --locked --manifest-path src/one_bridge_canister/tests/fixtures/Cargo.toml --release --target wasm32-unknown-unknown
cp src/one_bridge_canister/tests/fixtures/target/wasm32-unknown-unknown/release/bridge_test_fixture.wasm "$task_target/test-wasm/ledger.wasm"
cargo build --locked --manifest-path src/one_bridge_canister/tests/fixtures/Cargo.toml --release --target wasm32-unknown-unknown --features legacy
cp src/one_bridge_canister/tests/fixtures/target/wasm32-unknown-unknown/release/bridge_test_fixture.wasm "$task_target/test-wasm/legacy.wasm"
